...
<html>
  <head>
    <title>Redirect Form To a Particular Page On Submit - Demo Preview
    </title>
  ...
  <body>
    <div class="main">
      <div class="first">
        <h2>Redirect Form To a Particular Page On Submit using PHP
        </h2>
        <form action="RedirectForm.php" id="#form" method="post" name="#form">
          <label>Name :
          </label>
          ...
          <?php
include "include/RedirectForm.php";
?>
        </form>
      </div>
    </div>
