...
e = float(form.getvalue("lb_error"))
z = float(form.getvalue("lb_confiabilidad"))
p = float(form.getvalue("lb_p_necesaria"))
q = float(form.getvalue("lb_p_restante"))
n = float(form.getvalue("lb_estratos"))
