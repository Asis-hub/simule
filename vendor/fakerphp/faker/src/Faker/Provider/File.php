...
class File extends Base
{
    ...
    public static function file($sourceDirectory = '/tmp', $targetDirectory = '/tmp', $fullPath = true)
    {
        ...
        $files = array_filter(array_values(array_diff(scandir($sourceDirectory), ['.', '..'])), static fn($file) => is_file($sourceDirectory . DIRECTORY_SEPARATOR . $file) && is_readable($sourceDirectory . DIRECTORY_SEPARATOR . $file));
