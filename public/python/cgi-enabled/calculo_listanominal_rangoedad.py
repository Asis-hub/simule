...
print("Lista nominal de 25-34 años hombres: " + (str(int(suma_listahombres25_29 + suma_listahombres30_34))))
print("Lista nominal de 25-34 años mujeres: " + (str(int(suma_listamujeres25_29 + suma_listamujeres30_34))))

print("Lista nominal de 35-49 años hombres: " + (str(int(suma_listahombres35_39 + suma_listahombres40_44 + suma_listahombres45_49))))
print("Lista nominal de 35-49 años mujeres: " + (str(int(suma_listamujeres35_39 + suma_listamujeres40_44 + suma_listamujeres45_49))))

print("Lista nominal de 50-64 años hombres: " + (str(int(suma_listahombres50_54 + suma_listahombres55_59 + suma_listahombres60_64))))
print("Lista nominal de 50-64 años mujeres: " + (str(int(suma_listamujeres50_54 + suma_listamujeres55_59 + suma_listamujeres60_64))))

print("Lista nominal de 25-34 años hombres: " + (str(int(suma_listahombres65_mas))))
print("Lista nominal de 25-34 años mujeres: " + (str(int(suma_listamujeres65_mas))))
